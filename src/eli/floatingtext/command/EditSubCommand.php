...
use eli\floatingtext\form\EditFloatingTextForm;
use eli\floatingtext\form\EditSelectionForm;
...
class EditSubCommand extends BaseSubCommand
{
    ...
    public function onRun(CommandSender $sender, string $commandLabel, array $args): void
    {
        ...
        if (!isset($args["floating_text"])) {
            new EditFloatingTextForm($sender);
            return;
        }
        ...
        new EditSelectionForm($sender, $text->getIdentifier());
    }
}
